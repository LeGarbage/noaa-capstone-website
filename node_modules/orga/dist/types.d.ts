import type { Literal as UnistLiteral, Node, Parent as UnistParent } from 'unist';
...
export type BlockContent = Section | Paragraph | Block | Drawer | Planning | List | Table | HorizontalRule | Headline | HTML | JSX | Latex;
type TopLevelContent = BlockContent | Keyword | Footnote;
export type Content = TopLevelContent | TableContent | TableRow | TableCell | ListContent | PhrasingContent;
...
export type Token = Keyword | Todo | Newline | EmptyLine | HorizontalRule | Stars | Priority | Tags | PlanningKeyword | PlanningTimestamp | ListItemTag | ListItemCheckbox | ListItemBullet | TableRule | TableColumnSeparator | PhrasingContent | FootnoteLabel | BlockBegin | BlockEnd | LatexBegin | LatexEnd | DrawerBegin | DrawerEnd | Comment | Opening | Closing | LinkPath;
export type PhrasingContent = Text | Link | FootnoteReference | Newline | EmptyLine | HTML | JSX;
...
export type Style = 'bold' | 'verbatim' | 'italic' | 'strikeThrough' | 'underline' | 'code' | 'math';
...
export declare function isSection(node: Node): node is Section;
